# Search, buy and route a phone number (Java)
...
java -cp 'target/dependency/*' phone-numbers/Main.java buy <groupId> <skuId>             # shows the cost warning and stops
java -cp 'target/dependency/*' phone-numbers/Main.java buy <groupId> <skuId> --confirm   # places the order and charges your balance
java -cp 'target/dependency/*' phone-numbers/Main.java route <didId> sip sip.example.com:5060
java -cp 'target/dependency/*' phone-numbers/Main.java route <didId> forward +14155550123
```
