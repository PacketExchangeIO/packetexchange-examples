# Search, buy and route a phone number (Go)
...
go run ./phone-numbers buy <groupId> <skuId>             # shows the cost warning and stops
go run ./phone-numbers buy <groupId> <skuId> --confirm   # places the order and charges your balance
go run ./phone-numbers route <didId> sip sip.example.com:5060
go run ./phone-numbers route <didId> forward +14155550123
```
