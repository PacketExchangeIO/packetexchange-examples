# Search, buy and route a phone number (Python)
...
python phone-numbers/main.py buy <groupId> <skuId>             # shows the cost warning and stops
python phone-numbers/main.py buy <groupId> <skuId> --confirm   # places the order and charges your balance
