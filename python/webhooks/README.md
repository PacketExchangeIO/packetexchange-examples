# Receive and verify webhooks (Python)
...
From the `python` folder (see the [Python README](../README.md) for setup):

```bash
export PACKETEXCHANGE_WEBHOOK_SECRET=...   # shown once when you create the endpoint
python webhooks/main.py   # listens on http://localhost:3000/webhooks (PORT to change)
```
