# Receive and verify webhooks (PHP)
...
From the `php` folder (see the [PHP README](../README.md) for setup):

```bash
export PACKETEXCHANGE_WEBHOOK_SECRET=...   # shown once when you create the endpoint
php -S localhost:3000 webhooks/index.php   # serves http://localhost:3000/webhooks
```
