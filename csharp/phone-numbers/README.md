# Search, buy and route a phone number (C#)
...
dotnet run --project phone-numbers -- buy <groupId> <skuId>             # shows the cost warning and stops
dotnet run --project phone-numbers -- buy <groupId> <skuId> --confirm   # places the order and charges your balance
dotnet run --project phone-numbers -- route <didId> sip sip.example.com:5060
dotnet run --project phone-numbers -- route <didId> forward +14155550123
```
