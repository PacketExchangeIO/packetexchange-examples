...
From the `csharp` folder (see the [C# README](../README.md) for setup):

```bash
export PACKETEXCHANGE_WEBHOOK_SECRET=...   # shown once when you create the endpoint
dotnet run --project webhooks   # listens on http://localhost:3000/webhooks (PORT to change)
```
