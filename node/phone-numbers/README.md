# Search, buy and route a phone number (Node.js)
...
node phone-numbers/index.ts buy <groupId> <skuId>             # shows the cost warning and stops
node phone-numbers/index.ts buy <groupId> <skuId> --confirm   # places the order and charges your balance
