# Receive and verify webhooks (Node.js)
...
From the `node` folder (see the [Node.js README](../README.md) for setup):

```bash
export PACKETEXCHANGE_WEBHOOK_SECRET=...   # shown once when you create the endpoint
node webhooks/index.ts   # listens on http://localhost:3000/webhooks (PORT to change)
```
