# Search, buy and route a phone number (Ruby)
...
From the `ruby` folder, with `PACKETEXCHANGE_API_KEY` set (see the [Ruby README](../README.md) for setup):

```bash
ruby phone-numbers/main.rb search 1415
ruby phone-numbers/main.rb buy <groupId> <skuId>             # shows the cost warning and stops
ruby phone-numbers/main.rb buy <groupId> <skuId> --confirm   # places the order and charges your balance
ruby phone-numbers/main.rb route <didId> sip sip.example.com:5060
ruby phone-numbers/main.rb route <didId> forward +14155550123
```
