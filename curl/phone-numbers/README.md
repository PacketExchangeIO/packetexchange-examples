# Search, buy and route a phone number (curl)
...
./phone-numbers/example.sh buy <groupId> <skuId>             # shows the cost warning and stops
./phone-numbers/example.sh buy <groupId> <skuId> --confirm   # places the order and charges your balance
